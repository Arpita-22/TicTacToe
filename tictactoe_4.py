...
class TicTacToe:
    ...
    def minimax(self, user_input, move, symbol,score = 0):
        ...
        # def maximizing(user_input, score):
        # if self.board[user_input] != " ":
        #     # move = True
        #     return score
        if self.board[user_input] != " ":
            if symbol == "0" and self.did_win() == True:
                score = 1
                print(score)
                return score
        ...
        elif self.board[user_input] == " ":
            self.board[user_input] = symbol

            if symbol == "0":
                move = True
                self.minimax(user_input, move, symbol, score)
            else:
                move = False
                self.minimax(user_input, move, symbol, score)
        ...
        for position in self.board:
            ...
            if self.board[position] != " ":
                ...
                # elif self.did_win() == False:
                #     score = 0
                #     return score


            elif self.board[position] == " ":
                if self.board[position] == self.board[user_input]:
                    self.board[position] = symbol
                    if symbol == "0":
                        move = True
                        self.board[position] = " "
                        return self.minimax(position, move, symbol, score)
                    else:
                        move = False
                        return self.minimax(position, move, symbol, score)
                else:
